...
@Yash.on_message(filters.animation)
...
@Yash.on_message(filters.command(["start"]))
...
Made With Love By @DynicaBots</b>""",
        reply_markup=reply_markup,
        parse_mode="html",
        reply_to_message_id=message.message_id
    )

@Yash.on_message(filters.command(["help"]))
...
@Yash.on_callback_query()
async def button(Yash, update):
      cb_data = update.data
      if "help" in cb_data:
        await update.message.delete()
        await help(Yash, update.message)
      elif "close" in cb_data:
        await update.message.delete() 
      elif "home" in cb_data:
        await update.message.delete()
        await home(Yash, update.message)
